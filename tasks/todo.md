# Maz Works Call Desk — delivery checklist

- [x] Add prospect domain model, readiness rules, scripts, and tests.
- [x] Add local prospect API and deterministic website audit API.
- [x] Build the call-ready list, prospect editor, screening gate, script, notes, outcomes, and follow-ups.
