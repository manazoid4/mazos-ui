...
export const TOOL_SOURCES: ToolSource[] = [
  ...
  { id: 'appflowy', name: 'AppFlowy', kind: 'product', localPath: `${SUB}/appflowy`,
    ...
    safety: 'L1', readFirst: 'README.md' },
  { id: 'openwiki', name: 'OpenWiki', kind: 'product', localPath: `${SUB}/openwiki`,
    useWhen: 'Local-first knowledge capture, SQLite wiki, Markdown export, MCP-backed agent memory.',
    keywords: ['openwiki', 'wiki', 'knowledge', 'memory', 'capture', 'sqlite', 'mcp', 'markdown export', 'agent memory', 'handoff'],
    safety: 'L1', readFirst: 'docs/OPENWIKI_LOCAL_INSTALL.md' },
