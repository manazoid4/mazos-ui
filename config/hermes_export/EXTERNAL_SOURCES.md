...
Source of truth: `research/mazos/HERMES_EXTERNAL_SOURCES.md`

Live Hermes registry: `C:\Users\manaz\.hermes\mazos\EXTERNAL_SOURCES.md`

Use the external-agent-sources skill to route tasks:

- Headroom: context compression and reversible retrieval.
- Agent Reach: web reach and research channels.
- NVIDIA Skills: CUDA, Jetson, NeMo, cuOpt, GPU and NVIDIA platform work.
